...
<?php $disabled = (!$this->session->userdata('permissao')==1)?"disabled":"";?>
	            ...
	            <form class="form-horizontal" method="post" action="<?php echo base_url()?>main/alterar">
	            	<div class="box-body">
		                <div class="form-group">
			                  ...
			                  <div class="col-sm-6">
			                    	<input type="text" class="form-control" name="nome" id="nome" placeholder="Nome" value="<?php echo $nome?>" disabled="<?php echo $disabled; ?>" >
			                    	<?php echo $nome_error?>
			                  </div>
		                </div>
		                ...
		                <div class="form-group">
			                  ...
			                  <div class="col-sm-5">
			                    	<input type="text" class="form-control" name="usuario" id="usuario" placeholder="Usuário" value="<?php echo $usuario?>" disabled="<?php echo $disabled; ?>">
